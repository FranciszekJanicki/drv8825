...
static drv8825_err_t drv8825_pulse_init(drv8825_t const* drv8825)
{
    return drv8825->interface.pulse_init
               ? drv8825->interface.pulse_init(drv8825->interface.pulse_user)
               : DRV8825_ERR_NULL;
}

static drv8825_err_t drv8825_pulse_deinit(drv8825_t const* drv8825)
{
    return drv8825->interface.pulse_deinit
               ? drv8825->interface.pulse_deinit(drv8825->interface.pulse_user)
               : DRV8825_ERR_NULL;
}
...
static drv8825_err_t drv8825_gpio_init(drv8825_t const* drv8825)
{
    return drv8825->interface.gpio_init ? drv8825->interface.gpio_init(drv8825->interface.gpio_user)
                                        : DRV8825_ERR_NULL;
}

static drv8825_err_t drv8825_gpio_deinit(drv8825_t const* drv8825)
{
    return drv8825->interface.gpio_deinit
               ? drv8825->interface.gpio_deinit(drv8825->interface.gpio_user)
               : DRV8825_ERR_NULL;
}
                                 ...
                                 drv8825_interface_t const* interface)
{
    ...
    drv8825_err_t err = drv8825_pulse_init(drv8825);
    err |= drv8825_gpio_init(drv8825);
...
drv8825_err_t drv8825_deinitialize(drv8825_t const* drv8825)
{
    ...
    drv8825_err_t err = drv8825_gpio_deinit(drv8825);
    err |= drv8825_pulse_deinit(drv8825);
