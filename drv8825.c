...
static drv8825_err_t drv8825_pulse_set_freq(drv8825_t const *drv8825,
                                            uint32_t freq) {
  return drv8825->interface.pulse_set_freq
             ? drv8825->interface.pulse_set_freq(drv8825->interface.pulse_user,
                                                 freq)
             : DRV8825_ERR_NULL;
}
...
drv8825_err_t drv8825_set_full_microstep(drv8825_t const *drv8825) {
  ...
  drv8825_err_t err =
      drv8825_gpio_write_pin(drv8825, drv8825->config.pin_ms1, false);
...
drv8825_err_t drv8825_set_half_microstep(drv8825_t const *drv8825) {
  ...
  drv8825_err_t err =
      drv8825_gpio_write_pin(drv8825, drv8825->config.pin_ms1, true);
  err |= drv8825_gpio_write_pin(drv8825, drv8825->config.pin_ms2, false);
  err |= drv8825_gpio_write_pin(drv8825, drv8825->config.pin_ms3, false);
...
drv8825_err_t drv8825_set_decay(drv8825_t const *drv8825,
                                drv8825_decay_t decay) {
  assert(drv8825);
